 ...
 * @param (NSString*)configFileName                An string which specifies the name of the config file to use
 * @returns                     An ChatSDK shared Object
 */
+(ChatSDK *)initializeChat:(id)anonymous andConfig:(NSString*) configFileName;
